...
[European Open Source 3D Bioprinting Workshop 2023]{.underline}

* December 11-13, 2023, Vienna, Austria

```{r, echo = FALSE}

knitr::include_graphics("https://github.com/BSUBMEL/webpage/blob/main/images/News/GroupPhoto_EuropeanOpenSourceBioprinting_23.jpg?raw=true")

```
```{r, echo = FALSE, out.width= "33.33%"}

knitr::include_graphics("https://github.com/BSUBMEL/webpage/blob/main/images/News/Cathedral_EuropeanOpenSourceBioprinting_23.jpg?raw=true")

knitr::include_graphics("https://github.com/BSUBMEL/webpage/blob/main/images/News/CreamPrint_EuropeanOpenSourceBioprinting_23.jpg?raw=true")

knitr::include_graphics("https://github.com/BSUBMEL/webpage/blob/main/images/News/BuildingPrinter_EuropeanOpenSourceBioprinting_23.jpg?raw=true")

knitr::include_graphics("https://github.com/BSUBMEL/webpage/blob/main/images/News/Ingelprint_EuropeanOpenSourceBioprinting_23.jpg?raw=true")

knitr::include_graphics("https://github.com/BSUBMEL/webpage/blob/main/images/News/BoiseB_EuropeanOpenSourceBioprinting_23.jpg?raw=true")

knitr::include_graphics("https://github.com/BSUBMEL/webpage/blob/main/images/News/DroppingBox_EuropeanOpenSourceBioprinting_23.jpg?raw=true")
